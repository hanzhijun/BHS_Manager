...
//    redirect: '/interConfig/indexManage/indexSlideshowList',
    ...
    children: [
      //      商品
      { path: 'oneBuyGoodsList', component: _import('oneBuy/oneBuyGoods/oneBuyGoodsList'), name: 'oneBuyGoodsList', meta: { title: 'oneBuyGoodsList' }},
      { path: 'oneBuyGoodsDetail', component: _import('oneBuy/oneBuyGoods/oneBuyGoodsDetail'), name: 'oneBuyGoodsDetail', meta: { title: 'oneBuyGoodsDetail' }, hidden: true},

      //      用户
      { path: 'oneBuyUserList', component: _import('oneBuy/oneBuyUser/oneBuyUserList'), name: 'oneBuyUserList', meta: { title: 'oneBuyUserList' }},
      { path: 'oneBuyUserDetail', component: _import('oneBuy/oneBuyUser/oneBuyUserDetail'), name: 'oneBuyUserDetail', meta: { title: 'oneBuyUserDetail' }, hidden: true}
