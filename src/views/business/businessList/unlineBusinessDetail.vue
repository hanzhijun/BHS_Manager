...
//            this.baiduMap.clearOverlays()
      ...
      this.$axios({
        ...
        fuc: (res) => {
          ...
          this.$nextTick(() => {
            this.first_category_idChange(this.form.first_category_id)
          })
...
//        console.log(file)
      ...
      first_category_idChange (id) {
        console.log(id, this.first_category_idList)
        for (let val of this.first_category_idList) {
//          debugger
          if (val.business_category_id === id) {
            this.second_category_idList = val.child
            for (let childVal of val.child) {
              if (this.form.second_category_id && this.form.second_category_id == childVal.business_category_id) {
                return
